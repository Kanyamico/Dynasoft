	...
	<section id="content">
		...
		<main>
			<div class="todo">
				<div class="head">
					<center>
						<h3  style="color: rgb(106, 56, 143)">Shift Form</h3>
					</center>
				</div>
				...
				<div class="head">
					...
					<input type="datetime-local"  name="start" class="form-control icon" required><br><br>
				</div>

				<div class="head">
					<label for="">End_time</label>
					<input type="datetime-local"  name="end" class="form-control icon" required><br><br>
				</div>
				<div>
