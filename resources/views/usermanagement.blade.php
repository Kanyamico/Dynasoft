...
<body>
	...
	<section id="content">
		...
		<main>
            ...
            @foreach($users as $bootcampss)
            <tr>
              <td>{{$bootcampss->id}}</td>
              <td>{{$bootcampss->name}}</td>
              <td>{{$bootcampss ->usertype}}</td>
              <td>{{$bootcampss->email}}</td>
              ...
              <td style="display: flex;">
                <button type="button" style="color:#fff;text-decoration:none;" class="btn btn-success">
                  <a style="color:#ffff;" href="{{'editUser/'.$bootcampss->id}}">Edit</a>
                </button>
                <button type="button" style="color:#fff;text-decoration:none;background:red" class="btn btn-danger">
                <a style="color:#fff;" href="{{'deleteUser/'.$bootcampss ->id}}">Delete</a>
              </button>
              </td>
